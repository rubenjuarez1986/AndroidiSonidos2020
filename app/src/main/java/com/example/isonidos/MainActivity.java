...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0;i<listaCanciones.length;i++){
            //creamos un botón pot código y lo añadimos a la pantalla principal
            Button b = creaBoton(i, listaCanciones);
            //añadimos el botón al layaut
            auxiliar.addView(b);
    ...
    private Button creaBoton(int i, Field[] _listaCanciones){
        ...
        b.setAllCaps(true);//todas las letras del botón en mayúscula/munúscula
